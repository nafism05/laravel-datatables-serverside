# Laravel 8 datatables serverside
...
### Membuat Data Dummy
Buka file yang terletak di database/factories/UserFactory.php
&nbsp;
```
<?php
...
### Referensi:
- https://codelapan.com/post/yajra-datatables-server-side-laravel-8